...
namespace xUnitPlay.TestArtifacts
{
    ...
    public class ScenarioTestCase : LongLivedMarshalByRefObject, ITestCase, ITestMethod, IMethodInfo, IXunitTestCase, IReflectionMethodInfo
    {
        ...
        public FeatureFileTestClass FeatureFile => (FeatureFileTestClass)TestClass;
        ...
        {
            TestClass = data.GetValue<FeatureFileTestClass>("TestClass");
        ...
        {
            TestClass = featureFileTestClass;
            Name = scenario.Name;
